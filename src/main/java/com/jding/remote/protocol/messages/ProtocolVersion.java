...
import com.jding.remote.client.exceptions.InvalidMessageException;
...
public class ProtocolVersion implements Encodable {
    ...
    public static ProtocolVersion decode(InputStream in) throws RemoteException, IOException {
