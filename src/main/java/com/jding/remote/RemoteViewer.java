...
public class RemoteViewer extends JFrame {
        ...
        add(new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                if (lastFrame != null) {
                    ...
                    String message = "No connection. Use \"File > Connect\" to connect to a remote phone.";
    ...
    private void showConnectDialog() {
        ...
        JTextField portField = new JTextField("5959");
        ...
        if (choice == OK_OPTION) {
            ...
            try {
                ...
                showMessageDialog(this, "Please enter a valid port", null, WARNING_MESSAGE, this.resizeIcon(warningIcon, 60, 60));
                return;
            }
            connect(host, port);
        }
    ...
    private String showUsernameDialog() {
        ...
        int choice = showConfirmDialog(this, usernameDialog, "Enter Username", OK_CANCEL_OPTION, 
            PLAIN_MESSAGE, this.resizeIcon(passwordIcon, 60, 60));
        if (choice == OK_OPTION) {
    ...
    private String showPasswordDialog() {
        ...
        int choice = showConfirmDialog(this, passwordDialog, "Enter Password", OK_CANCEL_OPTION, 
            PLAIN_MESSAGE, this.resizeIcon(passwordIcon, 60, 60));
        if (choice == OK_OPTION) {
            password = "Ding" + new String(passwordField.getPassword());
        }
        return password;
    }
    ...
    public static void main(String[] args) {
        invokeLater(() -> {
            RemoteViewer viewer = new RemoteViewer();
