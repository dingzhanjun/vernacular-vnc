...
import static com.jding.remote.client.rendering.ColorDepth.BPP_8_INDEXED;
...
public class VernacularConfig {
    ...
    private Consumer<RemoteException> errorListener;
    ...
    public Consumer<RemoteException> getErrorListener() {
     ...
     */
    public void setErrorListener(Consumer<RemoteException> errorListener) {
     ...
     * @see com.jding.remote.client.rendering.ColorDepth ColorDepth
     */
