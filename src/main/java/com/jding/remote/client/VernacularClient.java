...
import com.jding.remote.protocol.handshaking.Handshaker;
import com.jding.remote.protocol.initialization.Initializer;
import com.jding.remote.utils.KeySyms;
...
public class VernacularClient {
    ...
    public void start(String host, int port) {
        try {
            ...
            handleError(new UnexpectedRemoteException(e));
        }
    }
    ...
    private void createSession(Socket socket) throws IOException, RemoteException {
    ...
    private void notifyErrorListeners(RemoteException e) {
